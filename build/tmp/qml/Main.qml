...
MainView {
    ...
    applicationName: "flickdango.fandango"
    ...
    Page {
        ...
        WebEngineView {
            ...
            anchors {
                ...
                zoomFactor: 2.5
                url: "https://mobile.fandango.com/"

                userScripts: [
                    WebEngineScript {
                       name: "oxide://flickdango-no-omniprompt/"
                       sourceUrl: Qt.resolvedUrl("js/flickdango-no-omniprompt.js")
                       runOnSubframes: true
           }
        ]
